...
@SpringBootTest(classes = {EquipmentWriteServiceApplication.class, EquipmentCreator.class}, webEnvironment = RANDOM_PORT, properties = "test.url=http://localhost:9561")
@Testcontainers
